...
function GitkitClient(serverConfig) {
  this.widgetUrl = serverConfig.widgetUrl;
  this.maxTokenExpiration = 86400 * 30; // 30 days
  this.audience = serverConfig.clientId;
  this.authClient = new google.auth.JWT(
      serverConfig.serviceAccountEmail,
      serverConfig.serviceAccountPrivateKeyFile,
      undefined,
